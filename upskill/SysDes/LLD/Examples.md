...
3. **Shopping Cart** — catalog, add items, checkout, stock validation
4. **Payment Wallet** — user registration, balance, transfers, Fixed Deposits
5. **Custom HashMap** — buckets, custom hash, collision handling, rehashing
