> [!summary]
> Operating systems coordinate processes, memory, files, devices, scheduling, and protection between applications and hardware.
...
- [[Upskill/CS Topics/Concurrency-Parallelism-Async|Concurrency-Parallelism-Async]]
